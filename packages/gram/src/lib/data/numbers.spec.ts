...
describe('Patterns of numbers', () => {
  ...
  it('should combine two numbers', () => {
    ...
    expect(Pattern.value(one)).toEqual(Pattern.value(a));
    expect(Pattern.value(two)).toEqual(Pattern.value(b));
  });
  ...
  it('should map a pattern of numbers', () => {
    ...
    expect(Pattern.value(pn.members[0])).toEqual(3);
    expect(Pattern.value(pn.members[1])).toEqual(4);
