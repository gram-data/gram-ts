...
export const make = <ID, R extends SubjectRecord>(identifier: ID, labels: string[], record: R): Subject<ID,R> => ({
...
export const of = <ID, R extends SubjectRecord>(args: { 
  readonly identifier: ID, 
  readonly labels: string[], 
  readonly record: R }) => make(args.identifier, args.labels, args.record)

export const fromObject = <R extends SubjectRecord>(o: R) => make(null, [], o)

export const equals = <ID, R extends SubjectRecord>(a: Subject<ID, R>, b: Subject<ID, R>): boolean => 
